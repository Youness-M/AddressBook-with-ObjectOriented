        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    <li class="active">
                        <a class="" href="dashbord.php?login">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?contact=list">لیست تلفن ها</a></li>
                            <li><a class="" href="dashbord.php?contact=add">افزودن تلفن</a></li>
                            <li><a class="" href="dashbord.php?contact=search">جستجو تلفن</a></li>
                        </ul>
                    </li>

                    <li>
                        <a class="" href="dashbord.php?logout=ok">
                            <i class="icon-user"></i>
